...
#
# Generated by export_simulation on Fri Jul 31 17:21:15 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './P1_B_Rom.sh' script.

./P1_B_Rom.sh -reset_run
...
./P1_B_Rom.sh -noclean_files

For more information on the script, please type './P1_B_Rom.sh -help'.
