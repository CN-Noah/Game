...
#
# Generated by export_simulation on Thu Jul 30 21:57:39 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Box_B_Rom.sh' script.

./Box_B_Rom.sh -reset_run
...
./Box_B_Rom.sh -noclean_files

For more information on the script, please type './Box_B_Rom.sh -help'.
