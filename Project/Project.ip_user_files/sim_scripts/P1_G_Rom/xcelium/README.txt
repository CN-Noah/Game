...
#
# Generated by export_simulation on Fri Jul 31 17:20:00 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './P1_G_Rom.sh' script.

./P1_G_Rom.sh -reset_run
...
./P1_G_Rom.sh -noclean_files

For more information on the script, please type './P1_G_Rom.sh -help'.
