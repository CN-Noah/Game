...
#
# Generated by export_simulation on Thu Jul 30 21:56:25 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Box_G_Rom.sh' script.

./Box_G_Rom.sh -reset_run
...
./Box_G_Rom.sh -noclean_files

For more information on the script, please type './Box_G_Rom.sh -help'.
