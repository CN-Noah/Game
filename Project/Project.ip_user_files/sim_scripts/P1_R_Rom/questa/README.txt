...
#
# Generated by export_simulation on Fri Jul 31 17:18:51 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './P1_R_Rom.sh' script.

./P1_R_Rom.sh -reset_run
...
./P1_R_Rom.sh -noclean_files

For more information on the script, please type './P1_R_Rom.sh -help'.
