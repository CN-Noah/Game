...
HD_PWD='C:/Users/z1528/Desktop/SEA_S7/Tests/Game/Project/Project.runs/Box_G_Rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Box_G_Rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Box_G_Rom.tcl
